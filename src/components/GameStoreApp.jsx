...
function GameStoreApp() {
  ...
  return (
    <div className="overflow-x-hidden w-full min-h-screen text-white bg-neutral-900">
      <Navbar searchQuery={searchQuery} onSearch={handleSearch} />
      <main className="px-6 py-8 mx-auto my-0 max-w-[1600px] max-sm:px-4 max-sm:py-6">
